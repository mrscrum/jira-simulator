...
decision/sampling kernel (`M1-T03`), including its slotted value/reconstruction boundary. None of
these records claims deployment, UAT, live Jira/OpenAI access, or M1 completion.
