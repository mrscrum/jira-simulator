...
decision/sampling kernel (`M1-T03`), including its slotted value/reconstruction boundary, plus the
pure DST-safe dual-clock calendar and federal-horizon slice (`M1-T04`). None of these records claims
deployment, UAT, live Jira/OpenAI access, or M1 completion.
